...
(function ($) {
    ...
    function setLanguage(lang) {
        if (document.getElementById("header-lang-img")) {
            if (lang == 'en') {
                document.getElementById("header-lang-img").src = "https://geochasqui.com/sistema_geo/public/images/flags/us.jpg";
            } else if (lang == 'sp') {
                document.getElementById("header-lang-img").src = "https://geochasqui.com/sistema_geo/public/images/flags/spain.jpg";
            } else if (lang == 'gr') {
                document.getElementById("header-lang-img").src = "https://geochasqui.com/sistema_geo/public/images/flags/germany.jpg";
            } else if (lang == 'it') {
                document.getElementById("header-lang-img").src = "https://geochasqui.com/sistema_geo/public/images/flags/italy.jpg";
            } else if (lang == 'ru') {
                document.getElementById("header-lang-img").src = "https://geochasqui.com/sistema_geo/public/images/flags/russia.jpg";
            }
    ...
    function getLanguage() {
        ...
        $.getJSON('https://geochasqui.com/sistema_geo/public/lang/' + language + '.json', function (lang) {
    ...
    function layoutSetting() {
        ...
        $("input[name='layout']").on('change', function () {
            ...
            if($(this).val()=="vertical"){
                $.ajax({
                    type: "POST",
                    url: 'https://geochasqui.com/sistema_geo/settings/activar_session_vertical',
                    data: {}, 
                    beforeSend:function(){
                    },   
                ...
                $.ajax({
                    type: "POST",
                    url: 'https://geochasqui.com/sistema_geo/settings/activar_session_horizontal',
                    data: {}, 
                    beforeSend:function(){
                    },   
                    success: function(data){ 
        ...
        $("input[name='layout-mode']").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: 'https://geochasqui.com/sistema_geo/settings/set_layout_mode',
                data: {'dato':$(this).val()}, 
                beforeSend:function(){
                },   
                success: function(data){ 
        ...
        $("input[name='layout-width']").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: 'https://geochasqui.com/sistema_geo/settings/set_layout_width',
                data: {'dato':$(this).val()}, 
                beforeSend:function(){
                },   
                success: function(data){ 
        ...
        $("input[name='layout-position']").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: 'https://geochasqui.com/sistema_geo/settings/set_layout_position',
                data: {'dato':dato}, 
                beforeSend:function(){
                },   
                success: function(data){ 
        ...
        $("input[name='sidebar-color']").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: 'https://geochasqui.com/sistema_geo/settings/set_sidebar_color',
                data: {'dato':dato}, 
                beforeSend:function(){
                },   
                success: function(data){ 
        ...
        $("input[name='topbar-color']").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: 'https://geochasqui.com/sistema_geo/settings/set_topbar_color',
                data: {'dato':$(this).val()}, 
                beforeSend:function(){
                },   
                success: function(data){ 
        ...
        $("input[name='sidebar-size']").on('change', function () {
            ...
            $.ajax({
                type: "POST",
                url: 'https://geochasqui.com/sistema_geo/settings/sidebar_size',
                data: {'dato':dato}, 
                beforeSend:function(){
                },   
                success: function(data){ 
        ...
        $("input[name='layout-direction']").on('change', function () {
            if($(this).val() == "ltr") {
                ...
                document.getElementById('bootstrap-style').setAttribute('href', 'https://geochasqui.com/sistema_geo/public/css/bootstrap.min.css');
                document.getElementById('app-style').setAttribute('href', 'https://geochasqui.com/sistema_geo/public/css/app.min.css');
            } else {
                document.getElementById('bootstrap-style').setAttribute('href', 'https://geochasqui.com/sistema_geo/public/css/bootstrap-rtl.min.css');
                document.getElementById('app-style').setAttribute('href', 'https://geochasqui.com/sistema_geo/public/css/app-rtl.min.css');
