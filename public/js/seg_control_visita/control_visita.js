                ...
                if(json!='error'){
                    ...
                    for (let index = 0; index < json.length; index++) {
                        ...
                        contenido +='<tr  style="color:#74788D;" >';
                            ...
                            contenido += '<td><button class="btn btn-sm btn-primary p-1" title="Editar equipo" onclick="abrir_segmento_data_equipo(' + json[index]['id'] + ')"><i class="mdi mdi-pencil"></i></button></td>';
    ...
    $.ajax({
        ...
        success: function(data){ 
            if (data == 1) {
                ...
                alertify.success('Se agregó control de calidad.');
