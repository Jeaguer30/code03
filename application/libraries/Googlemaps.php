...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCU7biKMhO8YgpD8c2Jg-KXT4sPsSqQByY'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function Googlemapsx($config = array())
	{
		if (count($config) > 0)
		{
	...
	function setheight($pixeles){
		$this->map_height=$pixeles;
	}	
}
